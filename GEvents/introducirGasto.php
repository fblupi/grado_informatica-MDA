...
<article>
	<form class="form-signin" method="POST" id="formularioIntroducirGasto" name="formularioIntroducirGasto" action="" data-toggle="validator" enctype="multipart/form-data">
